...
" title="Show More" height={48} textStyles="font-light text-[10px] sm:text-sm" className="sm:w-[140px] w-[100px]" width={44} />
              ...
              <div>
                <div>
                  <h1 className="mb-2 text-2xl font-vissa uppercase tracking-[0.02em]">Trophy time: CID Award-winners strike a pose</h1>
...
" title="Show More" height={48} textStyles="font-light text-[10px] sm:text-sm" className="sm:w-[140px] w-[100px]" width={44} />
              ...
              <div>
                <div>
                  <h1 className="mb-2 text-2xl font-vissa uppercase tracking-[0.02em]">On stage: The CID Awards 2024 MENA winners
                  </h1>
                  <p className="text-gray-400 text-sm font-houschka font-light  tracking-[0.02em]">Featured on (Commercial Interior Design)</p>
