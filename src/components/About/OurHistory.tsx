...
const OurHistory = () => {
  return (
    <div className="bg-[#FFEADF] lg:h-[1100px] lg:py-0 pt-20 relative">
      <img src={Historybg} className="absolute inset-0 object-cover h-full" alt="Background" />
      <div className="flex xl:gap-14 lg:gap-7 gap-12 h-full lg:flex-row items-center flex-col-reverse">
        <div className="lg:w-1/2 h-full">
          <img src={HistoryImg} className="h-full w-full object-cover object-[75%_25%] relative z-50" alt="Govind Shepley" />
        </div>
        <div className="text-black lg:text-start text-center lg:max-w-full lg:w-1/2 lg:pr-4 px-4 max-w-2xl">
          <h1 className="sm:mb-5 mb-4 md:text-[68px] sm:text-5xl text-2xl tracking-[0.04em] font-vissa">
            From Apartment 2106 to a Powerhouse Design Studio
          </h1>
          <p className="font-houschka sm:text-xl text-base font-light sm:mb-7 mb-5">
            In 2018, Govind Shepley turned apartment 2106 into the launchpad for what would
          ...
          <p className="font-houschka sm:text-xl text-base font-light sm:mb-5 mb-8">
            Today, we are synonymous with award-winning hospitality and F&B design, led by
          ...
          <p className="font-houschka sm:text-xl text-base font-light sm:mb-5 mb-8">
            Let’s just say, when you walk into a TwentyOne06-designed space, you’re walking into a
            story.
          </p>
          ...
          <Link to="/contact-us">
            <button className="relative">
              <span className="font-houschka font-light uppercase xl:text-lg sm:text-base text-[10px] absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 w-full">
                Let Us Design Your Story
              </span>
              <img
                height={180}
                width={180}
                className="scale-x-[-1] xl:size-auto size-[90px] sm:size-[140px]"
                src={ButtonVector}
                alt="Button Vector"
              />
            </button>
