import DesignDetailsPlaceholder from "../../assets/Project3-3.png"
import DesignDetailsPlaceholder2 from "../../assets/Project3-4.png"
import DesignDetailsPlaceholder3 from "../../assets/Project3-5.png"
import DesignDetailsPlaceholder4 from "../../assets/Project3-6.png"
import DesignDetailsPlaceholder5 from "../../assets/Project3-7.png"
import DesignDetailsPlaceholder6 from "../../assets/Creation3.jpg"
import DesignDetailsPlaceholder7 from "../../assets/Project3-8.png"
import DesignDetailsPlaceholder8 from "../../assets/Project3-9.png"
import DesignDetailsPlaceholder9 from "../../assets/Project3-10.png"
import DesignDetailsPlaceholder11 from "../../assets/Project3-11.png"
import DesignDetailsPlaceholder12 from "../../assets/Project3-12.png"
import DesignDetailsPlaceholder13 from "../../assets/Project3-13.png"
            ...
            <div className="max-w-[1832px] mx-auto px-4">
                ...
                <div className="flex md:gap-8 sm:gap-5 gap-2 lg:pb-40 md:pb-32 sm:pb-24 pb-16 relative">
                    <div className="w-1/2 basis-1/2 h-full">
                        <img src={DesignDetailsPlaceholder5} className="lg:max-h-[940px] md:h-[460px] lg:h-full w-full object-cover" alt="" />
...
twist to the minimalist design.</p>
                    ...
                    <div className="w-1/2 basis-1/2">
                        <img src={DesignDetailsPlaceholder6} className="w-full object-cover" alt="" />
                    </div>
            ...
            <div className="max-w-[1832px] mx-auto px-4 w-full">
                <div className="lg:mt-16 sm:mt-10 mt-4  md:text-2xl sm:text-lg text-sm font-light font-houschka space-y-4 md:space-y-8 md:w-full w-[200%] lg:mb-36 md:mb-28 sm:mb-16 mb-8">
