...
const ProjectDetail = () => {
  return (
    <div className="sm:py-28 relative py-16">
      ...
      <p className="text-[#D0D0D0] max-w-[1411px] mx-auto font-houschka font-light md:text-2xl sm:text-2xl text-base">TwentyOne06 revitalizes Pitfire Pizza's decade-long brand with a design narrative inspired by the 'religion of baking, 'ushering in raw and rustic elements to its first licensed venue in Dubai.</p>
