...
const ProjectDetail = () => {
  return (
    <div className="sm:py-28 relative py-16">
      ...
      <h1 className="uppercase font-vissa tracking-[0.04em] lg:text-[68px] md:text-6xl sm:text-5xl text-4xl leadng-none">PITFIRE PIZZA BAKERSTwentyOne06</h1>
      <p className="text-[#D0D0D0] max-w-[1411px] mx-auto font-houschka font-light md:text-2xl sm:text-lg text-sm">TwentyOne06 revitalizes Pitfire Pizza's decade-long brand with a design narrative inspired by the 'religion of baking, 'ushering in raw and rustic elements to its first licensed venue in Dubai .</p>
