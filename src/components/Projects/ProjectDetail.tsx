...
const ProjectDetail = () => {
  return (
    <div className="sm:py-28 relative py-16">
      ...
      <p className="text-[#D0D0D0] max-w-[1411px] mx-auto font-houschka font-light md:text-xl sm:text-xl text-xl">The core of Nama Yoso embodies the concept of "Raw Materials," which significantly shaped its interior and branddesign direction. This project was designed and completed for the award-winning celebrity chef, Reif Othman.</p>
      ...
      <div className=" font-houschka space-y-2.5 font-light">
        ...
        <p className="sm:text-lg text-xs text-[#D0D0D0] leading-none">NAMA YOSO</p>
      </div>
      <div className=" font-houschka space-y-2.5 font-light">
        <h1 className="sm:text-[26px] text-sm leading-none">Location</h1>
        <p className="sm:text-lg text-xs text-[#D0D0D0] leading-none">Mirdif Avenue Mall, Dubai </p>
      </div>
      <div className=" font-houschka space-y-2.5 font-light">
