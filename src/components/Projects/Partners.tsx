            ...
            <div className="h-full gradient-bg flex items-center justify-center relative " >
                <div className="relative z-[9999999] container mx-1">
                    ...
                    <div className="col-span-1">
                        ...
                        <div className="col-span-1">
                            <img className="mx-auto md:max-w-[125px] max-w-[125px] basis-1/4" src={Partner4} alt="Partner 4" />
                        </div>
                        <div className="col-span-1">
                            <img className="mx-auto md:max-w-[150px] max-w-[150px] basis-1/4" src={Partner5} alt="Partner 4" />
                        </div>
                        <div className="col-span-1">
                            <img className="mx-auto md:max-w-[150px] max-w-[150px] basis-1/4" src={Partner6} alt="Partner 4" />
                        </div>
                        <div className="col-span-1">
                            <img className="mx-auto md:max-w-[150px] max-w-[150px] basis-1/4" src={Partner7} alt="Partner 4" />
                        </div>
                        <div className="col-span-1">
                            <img className="mx-auto md:max-w-[150px] max-w-[150px] basis-1/4" src={Partner8} alt="Partner 4" />
                        </div>
                    </div>
                </div>
            </div>
