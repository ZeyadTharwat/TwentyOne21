    ...
    <div className="md:py-32 sm:py-24 py-16 xl:py-56 relative">
      ...
      <div className="container lg:flex-row flex-col-reverse flex xl:gap-x-[110px] gap-x-12 items-center relative z-50">
        ...
        <div className="md:text-start text-center">
          <h1 className="xl:text-6xl lg:text-5xl md:text-4xl sm:text-3xl text-2xl font-vissa uppercase tracking-[0.02em] sm:mb-8 mb-4">Exclusivity Meets Innovation</h1>
          <p className="font-houschka font-light text-[#D0D0D0] sm:text-lg text-sm md:mb-16 mb-12 md:pb-1.5">At the intersection of creativity and innovation, TwentyOne06 is a design agency redefining the boundaries of contemporary hospitality and commercial spaces. Based in Dubai, with a global reach, we specialize in crafting experiences that merge form with function, offering bespoke design solutions that are as innovative as they are timeless.</p>
