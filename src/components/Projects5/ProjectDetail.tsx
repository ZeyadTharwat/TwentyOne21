...
const ProjectDetail = () => {
  return (
    <div className="sm:py-28 relative py-16">
      ...
      <p className="text-[#D0D0D0] max-w-[1411px] mx-auto font-houschka font-light md:text-2xl sm:text-lg text-sm">The VOCO™ Monaco Hotel refurbishment project in Dubai transforms the hotel into a vibrant destination, blending
familiar comforts with unique elements. It offers a relaxed atmosphere for adult guests seeking vibrant social
experiences and relaxation, following the brand philosophy of "Small Change, Big Impact."</p>
