import DesignDetailsPlaceholder from "../../assets/Voco/image-1.jpg"
import DesignDetailsPlaceholder2 from "../../assets/Voco/image-2.jpg"
...
import DesignDetailsPlaceholder6 from "../../assets/Voco/10.jpg"
import DesignDetailsPlaceholder7 from "../../assets/Voco/5.jpg"
import DesignDetailsPlaceholder8 from "../../assets/Voco/image-8.jpg"
import DesignDetailsPlaceholder9 from "../../assets/Voco/6.jpg"
import DesignDetailsPlaceholder10 from "../../assets/Voco/image-10.jpg"
import DesignDetailsPlaceholder11 from "../../assets/Voco/image-11.jpg"
import DesignDetailsPlaceholder12 from "../../assets/Voco/7.jpg"
import DesignDetailsPlaceholder13 from "../../assets/Voco/8.jpg"
import DesignDetailsPlaceholder14 from "../../assets/Voco/9.jpg"
import DesignDetailsPlaceholder19 from "../../assets/Voco/C01 (1).jpg"
import DesignDetailsPlaceholder20 from "../../assets/Voco/1.jpg"
import DesignDetailsPlaceholder21 from "../../assets/Voco/2.jpg"
            ...
            <div className="max-w-[1832px] mx-auto px-4 w-full">
                ...
                <div className="2xl:gap-x-9 lg:gap-x-4 gap-x-3 grid grid-cols-6 w-full 2xl:gap-y-6 gap-y-5 pb-28">
                    ...
                    <div className="xl:col-span-2 col-span-3">
                        ...
                        <div className="space-y-4 text-center sm:mt-6 mt-2 md:text-xl sm:text-xl text-base font-light font-houschka text-[#D0D0D0]">
                    ...
                    <div className="xl:col-span-2 col-span-3">
                        ...
                        <div className="md:text-xl text-center sm:text-xl text-base font-light font-houschka space-y-4  mt-6 text-[#D0D0D0] w-full">
                            <p>The Jungle Room</p>
                        </div>
                    ...
                    <div className="flex justify-between items-center 2xl:gap-28 xl:gap-12 lg:gap-5 border-b-2 border-primary lg:pb-20 pb-10 lg:mb-20  mb-12">
                        ...
                        <div className="flex justify-between items-center md:mb-11 mb-9">
                                ...
                                <div className='lg:hidden block'>
                                    <img src={Review4} className='md:size-40 sm:size-28 size-20 rounded-full object-cover object-top' alt="" />
                                </div>
