            ...
            <div className="h-full gradient-bg flex items-center justify-center relative " >
                <div className="relative z-[9999999] container mx-1">
                    ...
                    <div className="col-span-1 max-w-[170px]">
                            <img className="mx-auto md:max-w-[200px] max-w-[150px] basis-1/3" src={Partner1} alt="Partner 1" />
                        </div>
                        <div className="col-span-1 sm:min-w-[150px] sm:w-auto w-20">
                            <img className="mx-auto md:max-w-[200px] max-w-[150px] basis-1/3" src={Partner2} alt="Partner 2" />
                        </div>
                        <div className="col-span-1 sm:max-w-[300px] max-w-[200px]">
                            <img className="mx-auto md:max-w-[200px] max-w-[150px] basis-1/3" src={Partner3} alt="Partner 3" />
                        </div>
                    </div>
                </div>
            </div>
