...
const Button = ({title , className , height , width, textStyles, dir = "#", aspects} : {title:string; className?:string; height?:number; width?:number; textStyles?:string; dir?:string; aspects?:string;}) => {
  return (
    <Link to={dir}>
