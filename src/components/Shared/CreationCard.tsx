...
const CreationCard = ({project , type , dir = ""} : {project:string; type:string; dir?:string;}) => {
  return (
    <Link to={dir}>
        <div className="group relative">
    <img className="sm:max-h-[433px] sm:h-[433px] w-full object-cover" src={CreationPlacehoder} />
