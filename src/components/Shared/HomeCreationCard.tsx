...
const HomeCreationCard = ({project , type , dir = ""} : {project:string; type:string; dir?:string;}) => {
  return (
    <Link to={dir}>
        <div className="group relative">
    <img className="lg:max-h-[433px] lg:h-[433px] w-full object-cover" src={CreationPlacehoder} />
