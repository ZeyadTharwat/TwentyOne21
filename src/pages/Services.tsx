...
const Services = () => {
  return (
    <div className="grid lg:grid-cols-5 grid-cols-2 sm:grid-cols-4 w-full h-full">
        <div className="overflow-hidden w-full h-full col-span-1">
        ...
        <div className="overflow-hidden w-full h-full lg:block hidden col-span-1">
