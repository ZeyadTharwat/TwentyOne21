        ...
        <div>
            <div className="relative lg:pb-48 pt-40 ">
                ...
                <div className="text-center md:mb-24 mb-12 lg:mb-36 z-50 relative">
                    ...
                    <p className="font-light md:text-3xl sm:text-2xl text-lg tracking-[0.06em] font-houschka">Info@twentyone06.com</p>
                ...
                <div className='grid lg:grid-cols-5 grid-cols-1 gap-y-16 max-w-[1660px] lg:px-5 mx-auto z-50 relative'>
                    <div className="lg:col-span-2 col-span-1 lg:text-start text-center">
                        <div className="md:mb-14 mb-8">
                            ...
                            <h2 className="font-vissa text-3xl md:text-5xl tracking-[0.02em] mb-4">
                                (971) 455-48082
                            </h2>
                            <h2 className="font-vissa text-3xl md:text-5xl tracking-[0.02em]">
                        ...
                        <div className="md:mb-16 mb-8">
                            ...
                            <h2 className="font-vissa text-3xl md:text-5xl tracking-[0.02em]">Info@twentyone06.com</h2>
                        </div>
                        <div>
