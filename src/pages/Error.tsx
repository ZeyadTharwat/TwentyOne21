  ...
  return (
    <div className="relative h-screen">
        ...
        <div className="h-full w-full absolute flex items-center justify-center flex-col px-6 text-center">
            ...
            <h2 className="xl:text-[78px] lg:text-6xl md:text-5xl  text-[38px] tracking-[0.04em] font-vissa leading-none uppercase mb-6">Sorry! The page isn't found here</h2>
            <Button dir="/" aspects="md:size-auto size-9" textStyles="font-light md:text-lg text-[10px]" height={64} width={60} className="md:w-[220px] w-[150px]" title="Go To home page" />
        </div>
